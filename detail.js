...
// => means It's a new feature that introduced in ES6 and is called arrow function. The left part denotes the input of a function and the right part the output of that function.


//CODE FOR FETCHING TRAILER
...
fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&append_to_response=casts,videos,images,releases`,
    function (movie) {
        ...
        document.title = `${title} - CinQ`;       //////....wo upper movie ka title ....//////
        ...
        <div class="detail-box">
            ...
            <div class="detail-content">
                ...
                <div class="meta-list">
                    <div class="meta-item">
                        <img src="image/star.png" width="20" height="20" alt="rating">
            ...
            <div class="title-wrapper">
                <h3 class="title-large">Trailer & Clips</h3>
            </div>
        ...
        for (const { key, name } of filterVideos(videos)) {
            ...
            videoCard.innerHTML = `
               <iframe width="500" height="295" src="https://www.youtube.com/embed/${key}?&theme=dark&color=white&rel=0" frameborder="0" allowfullscreen="1" title="${name}" class="img-cover" loading="lazy"></iframe>
           `;
