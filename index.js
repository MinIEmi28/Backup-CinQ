...
// Importing all components & function 
  ...
  const genreList = {
    ...
    asString(genreIdList){
        ...
        for(const genreId of genreIdList){
            this[genreId] && newGenreList.push(this[genreId]);    //here this is genreList.
        }
...
<div class="slider-control">
    ...
    for(const[index,movie] of movieList.entries()){
        ...
        <div class="banner-content">
            ...
            <a href="detail.html" class="btn" onclick="getMovieDetail(${id})">
                <img src="image/play_circle.png" width="24" height="24" aria-hidden="true"
                    alt="play circle">
        ...
        <img src="${imageBaseURL}w154${poster_path}" alt="Slide to ${title}" loading="lazy" draggable="false"
        class="img-cover">
        `;
    ...
    //fetching data for home page section
...
const addHeroSlide = function(){
    ...
    const sliderStart=function(){
        ...
        this.classList.add("active");   //here this = slider-control
...
//main pg me search func perform krne ke liye uper search.js ko import kiye then search func call krre movie ke starting words bhi dete h to reference deta h 
search();        